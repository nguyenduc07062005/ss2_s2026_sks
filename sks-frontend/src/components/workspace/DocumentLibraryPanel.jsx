...
const ChildFolderRow = ({ folder, onOpenFolder }) => (
  <button
    ...
    className="grid w-full gap-5 px-7 py-5 text-left transition hover:bg-slate-50 lg:px-10 xl:grid-cols-[minmax(0,1fr),auto] xl:items-center"
  >
    <div className="flex min-w-0 items-start gap-4">
      <div className="mt-0.5 flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-amber-50 text-amber-600">
        <svg
      ...
      <div className="min-w-0">
        ...
        <p className="mt-2 text-base text-slate-500">Open folder</p>
      </div>
    </div>

    <div className="flex items-center gap-3 xl:justify-end">
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-400">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          fill="currentColor"
...
const DocumentRow = ({
  ...
  return (
    <article className="grid gap-5 px-7 py-5 transition hover:bg-slate-50 lg:px-10 xl:grid-cols-[minmax(0,1fr),auto] xl:items-center">
      <div className="flex min-w-0 items-start gap-4">
        <div
          className={`mt-0.5 flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl text-sm font-bold tracking-[0.22em] ${file.accent}`}
        >
          {file.label}
        </div>
        ...
        <div className="min-w-0 flex-1">
          <button
            ...
            className="truncate text-left text-xl font-semibold text-slate-950 transition hover:text-teal-700"
          >
...
const EmptyState = ({ title, description, code = 'DOCS' }) => (
  <div className="px-8 py-28 text-center lg:px-10">
    ...
    <p className="mt-6 text-lg font-semibold text-slate-700">{title}</p>
    {description ? (
            ...
            <div className="flex items-center justify-between px-5 py-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-50 disabled:opacity-40"
                >
                  Previous
                </button>
                <button
